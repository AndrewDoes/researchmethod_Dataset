...
"""
Refactored example of a Vehicle registration system.
"""
...
class VehicleRegistry:
    ...
    def add_vehicle_model_info(self, brand: str, model: str, catalogue_price: int, fuel_type: FuelType, year: int) -> None:
        """Add a VehicleModelInfo object to the list."""
    ...
    def find_vehicle_info(self, brand: str, model: str) -> VehicleModelInfo:
