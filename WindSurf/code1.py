...
class Employee:
    ...
    def take_holiday(self, payout: bool = False) -> None:
        ...
        if payout:
            self.pay_out_holidays()
        else:
            self.take_single_holiday()

    def pay_out_holidays(self) -> None:
        """Pay out 5 holidays if available."""
    ...
    def take_single_holiday(self) -> None:
        """Take a single holiday if available."""
...
def main() -> None:
    ...
    company.employees[0].take_holiday(False)
